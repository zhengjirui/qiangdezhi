...
public interface QUrl {
    ...
    String url = "http://qiangdezhi.com/";
    //String url = "http://101.132.105.201/appH/details-num/details/details.html";
    //正式
    //String url = "http://192.168.1.210:8889/";
    ...
    //滚动条接口(滚动的文字)
    String home_scrollTextView = "indexShow/daShu_ScrollBar";
    //首页四个栏目图片接口
