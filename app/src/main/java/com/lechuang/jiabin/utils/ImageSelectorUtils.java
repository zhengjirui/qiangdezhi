...
import com.lechuang.jiabin.view.activity.ImageSelectorActivity;
...
public class ImageSelectorUtils {
     ...
     * @param maxSelectCount 图片的最大选择数量，小于等于0时，不限数量，isSingle为false时才有用。
     */
    public static void openModifyPhoto(Activity activity, int requestCode,
                                  boolean isSingle, int maxSelectCount, ArrayList<String> list) {
        ImageSelectorActivity.openModifyActivity(activity, requestCode, isSingle, maxSelectCount,list);
    }
