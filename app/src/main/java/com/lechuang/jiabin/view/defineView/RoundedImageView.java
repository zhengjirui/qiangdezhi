...
public class RoundedImageView extends AppCompatImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_border_width_img, -1);
        ...
        borderColor = a.getColorStateList(R.styleable.RoundedImageView_border_color_img);
        if (borderColor == null) {
