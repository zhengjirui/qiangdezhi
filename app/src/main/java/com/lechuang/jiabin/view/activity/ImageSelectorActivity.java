...
import com.lechuang.jiabin.model.Folder;
import com.lechuang.jiabin.model.Image;
import com.lechuang.jiabin.model.ImageAdapter;
import com.lechuang.jiabin.presenter.adapter.FolderAdapter;
import com.lechuang.jiabin.presenter.card.ImageModel;
import com.lechuang.jiabin.utils.DateUtils;
...
public class ImageSelectorActivity extends AppCompatActivity {
    ...
    //2017/08/08添加到集合
    private static ArrayList<String> modifyList;
     ...
     * @param maxSelectCount 图片的最大选择数量，小于等于0时，不限数量，isSingle为false时才有用。
     */
    public static void openModifyActivity(Activity activity, int requestCode,
                                          boolean isSingle, int maxSelectCount, ArrayList<String> list) {
        modifyList = list;
        Intent intent = new Intent(activity, ImageSelectorActivity.class);
        intent.putExtra(Constants.MAX_SELECT_COUNT, maxSelectCount);
        intent.putExtra(Constants.IS_SINGLE, isSingle);
