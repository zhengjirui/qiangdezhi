 ...
 * @desc 栏目详情
 */
public class GetMoneyActivity extends BaseActivity implements OnItemClick {
...
//            Utils.show(mContext, "亲!已经到底了");
        ...
        if (page == 1) {
            if (mAdapter == null) {
                ...
                mAdapter.setOnItemClick(GetMoneyActivity.this);
            }
        } else {
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            // 去搜索
            case R.id.iv_search:
                startActivity(new Intent(GetMoneyActivity.this, SearchActivity.class).putExtra("whereSearch", 1));
                break;
            default:
                break;
        }
