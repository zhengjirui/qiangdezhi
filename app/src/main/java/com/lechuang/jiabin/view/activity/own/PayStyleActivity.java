...
public class PayStyleActivity extends AppCompatActivity {
   ...
   /* @BindView(R.id.cb_yuEpay)
    ...
    public void initView() {
        ...
        ((TextView) findViewById(R.id.tv_money)).setText(String.format("¥%s", getIntent().getStringExtra("payPriceStr")));
...
//                "http://192.168.1.210:8889/agency/agencySendOrder";
    ...
    private void pay() {
        Netword.getInstance().getApi(OwnApi.class)
                ...
                .subscribe(new ResultBack<OwnBean.Pay>(this) {
                    @Override
                    public void successed(OwnBean.Pay result) {
