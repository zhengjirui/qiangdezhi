...
public class VersionUpdateDialog extends Dialog {
        ...
        new Thread() {
            public void run() {
                try {
                    ...
                    sdpath = Environment.getExternalStorageDirectory() + "/" + context.getResources().getString(R.string.app_name) + "/";
    ...
    private void update() {
        ...
        File file = new File(Environment.getExternalStorageDirectory() + "/" + context.getResources().getString(R.string.app_name) + "/", context.getResources().getString(R.string.app_name) + ".apk");
