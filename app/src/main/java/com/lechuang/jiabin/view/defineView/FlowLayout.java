...
public class FlowLayout extends RelativeLayout {
    ...
    // 关键字背景框
    private int backgroundResource = R.drawable.bg_search_history;
    // 关键字水平padding，单位为dp
    private int textPaddingH = dp2px(15);
    // 关键字竖直padding，单位为dp
    private int textPaddingV = dp2px(5);
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.FlowLayout_itemSize:
                    textSize = typedArray.getDimensionPixelSize(attr, sp2px(15));
                    break;

                case R.styleable.FlowLayout_itemColor:
                    textColor = typedArray.getColor(attr, Color.BLACK);
                    break;

                case R.styleable.FlowLayout_backgroundResource:
                    backgroundResource = typedArray.getResourceId(attr, R.drawable.bg_search_history);
                    break;

                case R.styleable.FlowLayout_textPaddingH:
                    textPaddingV = typedArray.getDimensionPixelSize(attr, dp2px(7));
                    break;

                case R.styleable.FlowLayout_textPaddingV:
